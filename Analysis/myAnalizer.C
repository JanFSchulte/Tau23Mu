...
void myAnalizer::Loop_Tau3mu(TString type, TString datasetName)
{
	...
	L1TripleMu_passed = false;
        ...
        L1_DoubleMu0_er1p5 = 0, L1_DoubleMu0_er1p4 = 0, L1_DoubleMu4_dR1p2 = 0, L1_DoubleMu4p5_dR1p2 = 0, L1_DoubleMu0_er2p0 = 0, L1_DoubleMu0_er2p0_bk = 0, L1_TripleMu_5SQ_3SQ_0 = 0, L1_TripleMu_5SQ_3SQ_0OQ = 0, L1_TripleMu_3SQ_2p5SQ_0OQ_Mass_Max12 = 0, L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12 = 0, L1_TripleMu_4SQ_2p5SQ_0_OS_Mass_Max12=0, L1_DoubleMu0er1p4_SQ_OS_dEta_Max1p2=0, L1_DoubleMu4er2p0_SQ_OS_dR_Max1p6=0, L1_DoubleMu5_SQ_OS_dR_Max1p6 = 0, L1_DoubleMu3er2p0_SQ_OS_dR_Max1p6= 0, L1_DoubleMu0er1p5_SQ_OS_dEta_Max1p2 = 0;
...
//	    if (l1Name.Contains("L1_DoubleMu")) std::cout << l1Name << std::endl;
            ...
            if ((l1Name.Contains("L1_DoubleMu0er1p4_SQ_OS_dR_Max1p4") || l1Name.Contains("L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4") || l1Name.Contains("L1_DoubleMu4_SQ_OS_dR_Max1p2") || l1Name.Contains("L1_DoubleMu4p5_SQ_OS_dR_Max1p2") || l1Name.Contains("L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12") || l1Name.Contains("L1_TripleMu_3SQ_2p5SQ_0_OS_Mass_Max12") || l1Name.Contains("L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p6") || l1Name.Contains("L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p5") || l1Name.Contains("L1_DoubleMu0er1p4_SQ_OS_dEta_Max1p2")|| l1Name.Contains("L1_DoubleMu4er2p0_SQ_OS_dR_Max1p6")|| l1Name.Contains("L1_DoubleMu5_SQ_OS_dR_Max1p6")|| l1Name.Contains("L1_DoubleMu3er2p0_SQ_OS_dR_Max1p6")|| l1Name.Contains("L1_DoubleMu0er1p5_SQ_OS_dEta_Max1p2")|| l1Name.Contains("L1_TripleMu_4SQ_2p5SQ_0_OS_Mass_Max12") || l1Name.Contains("L1_TripleMu_5SQ_3SQ_0_DoubleMu_5_3_SQ_OS_Mass_Max9") || l1Name.Contains("L1_TripleMu_5SQ_3SQ_0OQ_DoubleMu_5_3_SQ_OS_Mass_Max9")) && Trigger_l1Finaldecision->at(h) == 1){

	       L1_passed = true; //cout << "L1 passed" << endl;
//	        std::cout << "prescale: " <<  (int)Trigger_l1prescale->at(h) << std::endl;

                if(l1Name.Contains("L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4") && Trigger_l1Finaldecision->at(h) == 1) {L1seed+=1; L1_DoubleMu0_er1p5 = Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu0er1p4_SQ_OS_dR_Max1p4") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu0_er1p4 = Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu4_SQ_OS_dR_Max1p2") && Trigger_l1Finaldecision->at(h) == 1) {L1seed+=10; L1_DoubleMu4_dR1p2=Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu4p5_SQ_OS_dR_Max1p2") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu4p5_dR1p2=Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_TripleMu_5SQ_3SQ_0OQ_DoubleMu_5_3_SQ_OS_Mass_Max9") && Trigger_l1Finaldecision->at(h) == 1) { L1seed+=100; L1_TripleMu_5SQ_3SQ_0OQ=Trigger_l1prescale->at(h); L1TripleMu_passed=true;}
                if(l1Name.Contains("L1_TripleMu_5SQ_3SQ_0_DoubleMu_5_3_SQ_OS_Mass_Max9") && Trigger_l1Finaldecision->at(h) == 1) {L1_TripleMu_5SQ_3SQ_0=Trigger_l1prescale->at(h); L1TripleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p6") && Trigger_l1Finaldecision->at(h) == 1) {L1seed+=1000; L1_DoubleMu0_er2p0=Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p5") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu0_er2p0_bk=Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12") && Trigger_l1Finaldecision->at(h) == 1) {L1seed+=10000; L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12 = Trigger_l1prescale->at(h); L1TripleMu_passed=true;}
                if(l1Name.Contains("L1_TripleMu_3SQ_2p5SQ_0_OS_Mass_Max12") && Trigger_l1Finaldecision->at(h) == 1) {L1_TripleMu_3SQ_2p5SQ_0OQ_Mass_Max12 = Trigger_l1prescale->at(h); L1TripleMu_passed=true;}
                if(l1Name.Contains("L1_TripleMu_4SQ_2p5SQ_0_OS_Mass_Max12") && Trigger_l1Finaldecision->at(h) == 1) {L1_TripleMu_4SQ_2p5SQ_0_OS_Mass_Max12 = Trigger_l1prescale->at(h); L1TripleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu0er1p4_SQ_OS_dEta_Max1p2") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu0er1p4_SQ_OS_dEta_Max1p2 = Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu4er2p0_SQ_OS_dR_Max1p6") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu4er2p0_SQ_OS_dR_Max1p6 = Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu5_SQ_OS_dR_Max1p6") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu5_SQ_OS_dR_Max1p6 = Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu3er2p0_SQ_OS_dR_Max1p6") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu3er2p0_SQ_OS_dR_Max1p6 = Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
                if(l1Name.Contains("L1_DoubleMu0er1p5_SQ_OS_dEta_Max1p2") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu0er1p5_SQ_OS_dEta_Max1p2 = Trigger_l1prescale->at(h); L1DoubleMu_passed=true;}
...
//	    cout << "HLT path: "<< hltName << " | decision: " << Trigger_hltdecision->at(h) << endl;
	    ...
	    //std::cout << "getting here" << std::endl;	
            ...
            TreeFin_Fill(tree, isMC, ind_good, mu_Ind_good, mu_good, lumi_n, run_n, evt_n, pileupFactor, category, L1_DoubleMu0_er1p5, L1_DoubleMu0_er1p4, L1_DoubleMu4_dR1p2, L1_DoubleMu4p5_dR1p2, L1_DoubleMu0_er2p0, L1_DoubleMu0_er2p0_bk, L1_TripleMu_5SQ_3SQ_0, L1_TripleMu_5SQ_3SQ_0OQ, L1_TripleMu_3SQ_2p5SQ_0OQ_Mass_Max12, L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12, L1_TripleMu_4SQ_2p5SQ_0_OS_Mass_Max12, L1_DoubleMu0er1p4_SQ_OS_dEta_Max1p2, L1_DoubleMu4er2p0_SQ_OS_dR_Max1p6, L1_DoubleMu5_SQ_OS_dR_Max1p6, L1_DoubleMu3er2p0_SQ_OS_dR_Max1p6, L1_DoubleMu0er1p5_SQ_OS_dEta_Max1p2, L1seed, HLTpath, deltaR_max, deltaZ_max, Pmu3, cLP, tKink, segmComp, tripletMass, tripletMassReso, fv_nC, fv_dphi3D, fv_d3D, fv_d3Dsig, d0, d0sig, mindca_iso, trkRel, Pmu1, Ptmu1, etamu1, Pmu2, Ptmu2, etamu2, Ptmu3, etamu3, P_trip, Pt_trip, eta_trip, nStationsMu1, nStationsMu2, nStationsMu3, Iso03Mu1, Iso03Mu2, Iso03Mu3, Iso05Mu1, Iso05Mu2, Iso05Mu3, nMatchesMu1, nMatchesMu2, nMatchesMu3, timeAtIpInOutMu_sig1, timeAtIpInOutMu_sig2, timeAtIpInOutMu_sig3, cQ_uS, cQ_tK, cQ_gK, cQ_tRChi2, cQ_sRChi2, cQ_Chi2LP, cQ_Chi2LM, cQ_lD, cQ_gDEP, cQ_tM, cQ_gTP, calEn_emMu1, calEn_emMu2, calEn_emMu3, calEn_hadMu1, calEn_hadMu2, calEn_hadMu3, caloComp, fliDistPVSV_Chi2, isGlb1, isTracker1, isLoose1,  isSoft1, isPF1, isRPC1, isSA1, isCalo1, isGlb2, isTracker2, isLoose2,  isSoft2, isPF2, isRPC2, isSA2, isCalo2, isGlb3, isTracker3, isLoose3,  isSoft3, isPF3, isRPC3, isSA3, isCalo3, vx1, vx2, vx3, vy1, vy2, vy3, vz1, vz2, vz3, Refvx1, Refvx2, Refvx3, Refvy1, Refvy2, Refvy3, Refvz1, Refvz2, Refvz3, SVx, SVy, SVz, had03, had05, nJets03, nJets05, nTracks03, nTracks05, sumPt03, sumPt05, hadVeto03, hadVeto05, emVeto03, emVeto05, trVeto03, trVeto05, EnMu1, EnMu2, EnMu3, ChargeMu1, ChargeMu2, ChargeMu3, isQValid1, isTValid1, isIsoValid1, GLnormChi2_mu1, GL_nValidMuHits1, trkLayersWMeas1, nValidPixelHits1, outerTrk_P_1, outerTrk_Eta_1, outerTrk_normChi2_1, outerTrk_muStValidHits_1, innerTrk_P_1, innerTrk_Eta_1, innerTrk_normChi2_1, QInnerOuter_1, cQ_uS_1, cQ_tK_1, cQ_gK_1, cQ_tRChi2_1, cQ_sRChi2_1, cQ_Chi2LP_1, cQ_Chi2LM_1, cQ_lD_1, cQ_gDEP_1, cQ_tM_1, cQ_gTP_1, segmComp_1, caloComp_1, isQValid2, isTValid2, isIsoValid2, GLnormChi2_mu2, GL_nValidMuHits2, trkLayersWMeas2, nValidPixelHits2, outerTrk_P_2, outerTrk_Eta_2, outerTrk_normChi2_2, outerTrk_muStValidHits_2, innerTrk_P_2, innerTrk_Eta_2, innerTrk_normChi2_2, QInnerOuter_2, cQ_uS_2, cQ_tK_2, cQ_gK_2, cQ_tRChi2_2, cQ_sRChi2_2, cQ_Chi2LP_2, cQ_Chi2LM_2, cQ_lD_2, cQ_gDEP_2, cQ_tM_2, cQ_gTP_2, segmComp_2, caloComp_2, isQValid3, isTValid3, isIsoValid3, GLnormChi2_mu3, GL_nValidMuHits3, trkLayersWMeas3, nValidPixelHits3, outerTrk_P_3, outerTrk_Eta_3, outerTrk_normChi2_3, outerTrk_muStValidHits_3, innerTrk_P_3, innerTrk_Eta_3, innerTrk_normChi2_3, QInnerOuter_3, cQ_uS_3, cQ_tK_3, cQ_gK_3, cQ_tRChi2_3, cQ_sRChi2_3, cQ_Chi2LP_3, cQ_Chi2LM_3, cQ_lD_3, cQ_gDEP_3, cQ_tM_3, cQ_gTP_3, segmComp_3, caloComp_3, dimu_OS1, dimu_OS2, L1DoubleMu_passed, L1TripleMu_passed, phi_mass, Mu3Matched3Mu, Mu3Matched2Mu1Tk, passControl, passSignal, MVASoft1, MVASoft2, MVASoft3, d0sig_max, match1_dX_1, match1_pullX_1, match1_pullDxDz_1, match1_dY_1, match1_pullY_1, match1_pullDyDz_1, match2_dX_1, match2_pullX_1, match2_pullDxDz_1, match2_dY_1, match2_pullY_1, match2_pullDyDz_1, match1_dX_2, match1_pullX_2, match1_pullDxDz_2, match1_dY_2, match1_pullY_2, match1_pullDyDz_2, match2_dX_2, match2_pullX_2, match2_pullDxDz_2, match2_dY_2, match2_pullY_2, match2_pullDyDz_2, match1_dX_3, match1_pullX_3, match1_pullDxDz_3, match1_dY_3, match1_pullY_3, match1_pullDyDz_3, match2_dX_3, match2_pullX_3, match2_pullDxDz_3, match2_dY_3, match2_pullY_3, match2_pullDyDz_3, validMuonHitComb1, validMuonHitComb2, validMuonHitComb3, nValidTrackerHits1, nValidTrackerHits2, nValidTrackerHits3, innerTrk_ValidFraction_1, innerTrk_ValidFraction_2, innerTrk_ValidFraction_3, innerTrk_highPurity_1, innerTrk_highPurity_2, innerTrk_highPurity_3, x_bs, y_bs, z_bs);
        }

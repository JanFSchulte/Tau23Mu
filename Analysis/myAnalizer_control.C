...
void myAnalizer_control::Loop_DsPhiPi(TString type, TString datasetName)
{
    ...
    for (Long64_t jentry=0; jentry<nentries;jentry++) {
        ...
        for(int i =0; i < GenParticle_PdgId->size(); i++){

		if (fabs(GenParticle_PdgId->at(i)) == 431) {
		 isPrompt = GenParticle_isDs->at(i);
		}
	}
	...
	for(int h=0; h<Trigger_l1name->size(); h++){
            ...
            if ((l1Name.Contains("L1_DoubleMu0er1p4_SQ_OS_dR_Max1p4") || l1Name.Contains("L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4") || l1Name.Contains("L1_DoubleMu4_SQ_OS_dR_Max1p2") || l1Name.Contains("L1_DoubleMu4p5_SQ_OS_dR_Max1p2") || l1Name.Contains("L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12") || l1Name.Contains("L1_TripleMu_3SQ_2p5SQ_0_OS_Mass_Max12") || l1Name.Contains("L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p6") || l1Name.Contains("L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p5") || l1Name.Contains("L1_DoubleMu0er1p4_SQ_OS_dEta_Max1p2")|| l1Name.Contains("L1_DoubleMu4er2p0_SQ_OS_dR_Max1p6")|| l1Name.Contains("L1_DoubleMu5_SQ_OS_dR_Max1p6")|| l1Name.Contains("L1_DoubleMu3er2p0_SQ_OS_dR_Max1p6")|| l1Name.Contains("L1_DoubleMu0er1p5_SQ_OS_dEta_Max1p2")|| l1Name.Contains("L1_TripleMu_4SQ_2p5SQ_0_OS_Mass_Max12") || l1Name.Contains("L1_TripleMu_5SQ_3SQ_0_DoubleMu_5_3_SQ_OS_Mass_Max9") || l1Name.Contains("L1_TripleMu_5SQ_3SQ_0OQ_DoubleMu_5_3_SQ_OS_Mass_Max9")) && Trigger_l1Finaldecision->at(h) == 1){
                ...
                if(l1Name.Contains("L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4") && Trigger_l1Finaldecision->at(h) == 1) {L1seed+=1; L1_DoubleMu0_er1p5 = Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu0er1p4_SQ_OS_dR_Max1p4") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu0_er1p4 = Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu4_SQ_OS_dR_Max1p2") && Trigger_l1Finaldecision->at(h) == 1) {L1seed+=10; L1_DoubleMu4_dR1p2=Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu4p5_SQ_OS_dR_Max1p2") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu4p5_dR1p2=Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_TripleMu_5SQ_3SQ_0OQ_DoubleMu_5_3_SQ_OS_Mass_Max9") && Trigger_l1Finaldecision->at(h) == 1) { L1seed+=100; L1_TripleMu_5SQ_3SQ_0OQ=Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_TripleMu_5SQ_3SQ_0_DoubleMu_5_3_SQ_OS_Mass_Max9") && Trigger_l1Finaldecision->at(h) == 1) {L1_TripleMu_5SQ_3SQ_0=Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p6") && Trigger_l1Finaldecision->at(h) == 1) {L1seed+=1000; L1_DoubleMu0_er2p0=Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p5") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu0_er2p0_bk=Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12") && Trigger_l1Finaldecision->at(h) == 1) {L1seed+=10000; L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12 = Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_TripleMu_3SQ_2p5SQ_0_OS_Mass_Max12") && Trigger_l1Finaldecision->at(h) == 1) {L1_TripleMu_3SQ_2p5SQ_0OQ_Mass_Max12 = Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_TripleMu_4SQ_2p5SQ_0_OS_Mass_Max12") && Trigger_l1Finaldecision->at(h) == 1) {L1_TripleMu_4SQ_2p5SQ_0_OS_Mass_Max12 = Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu0er1p4_SQ_OS_dEta_Max1p2") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu0er1p4_SQ_OS_dEta_Max1p2 = Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu4er2p0_SQ_OS_dR_Max1p6") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu4er2p0_SQ_OS_dR_Max1p6 = Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu5_SQ_OS_dR_Max1p6") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu5_SQ_OS_dR_Max1p6 = Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu3er2p0_SQ_OS_dR_Max1p6") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu3er2p0_SQ_OS_dR_Max1p6 = Trigger_l1prescale->at(h);}
                if(l1Name.Contains("L1_DoubleMu0er1p5_SQ_OS_dEta_Max1p2") && Trigger_l1Finaldecision->at(h) == 1) {L1_DoubleMu0er1p5_SQ_OS_dEta_Max1p2 = Trigger_l1prescale->at(h);}
	    ...
	    //CUT 6 SV chi2
	    if (RefittedSV_Chi2->at(j) >100) continue; 
